...
### PrimeNg
Used PrimeNg for quick set-up of the UI. Overall, I am a big fan of using libraries first instead of using custom solutions where it is not needed. Particularly table-related tasks like pagination/filtering, etc.
...
### Pipe for relative time - Done
### Guard for non-numeric ids - Done
### Unit tests - Did not do
### Dark mode - Done
I used PrimeNG's built-in solution, but in case I didn't have access to the library, I would use CSS's built-in light-dark function.
